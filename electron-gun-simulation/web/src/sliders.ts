...
const GROUPS: GroupDefinition[] = [
  {
    title: 'Filament',
    sliders: [
      { label: 'Radius',     field: 'filament_radius_mm',    min: 0.01,   max: 0.2,   step: 0.005, unit: 'mm' },
      { label: 'Thickness',  field: 'filament_thickness_mm', min: 0.01,   max: 0.2,   step: 0.005, unit: 'mm' },
      { label: 'z position', field: 'filament_z_mm',         min: -20.0,    max: 20.0,  step: 0.1,  unit: 'mm' },
      { label: 'Voltage',    field: 'filament_voltage_v',    min: -30000, max: 0, step: 100,  unit: 'V'  },
    ],
  },
  {
    ...
    sliders: [
      { label: 'Outer radius',    field: 'wehnelt_outer_radius_mm',    min: 6.0,   max: 10.0, step: 0.1,  unit: 'mm' },
      { label: 'Inner radius',    field: 'wehnelt_inner_radius_mm',    min: 4,   max: 7,  step: 0.1,  unit: 'mm' },
      { label: 'z position',      field: 'wehnelt_z_mm',               min: 1.0,   max: 20.0, step: 0.1,  unit: 'mm' },
      { label: 'Height',          field: 'wehnelt_height_mm',          min: 5.0,   max: 20.0, step: 1,  unit: 'mm' },
      { label: 'Cap thickness',   field: 'wehnelt_cap_thickness_mm',   min: 0.5,   max: 3.0,  step: 0.1, unit: 'mm' },
      { label: 'Aperture radius', field: 'wehnelt_aperture_radius_mm', min: 0.5,   max: 3.0,  step: 0.1, unit: 'mm' },
      { label: 'Bias voltage',    field: 'wehnelt_bias_v',             min: -200, max: 0,    step: 1,   unit: 'V'  },
    ],
  },
  {
    title: 'Anode',
    ...
    sliders: [
      { label: 'z position',      field: 'anode_z_mm',               min: -20,   max: 20.0, step: 0.1,  unit: 'mm' },
      { label: 'Thickness',       field: 'anode_thickness_mm',       min: 0.5,   max: 3.0,  step: 0.1,  unit: 'mm' },
